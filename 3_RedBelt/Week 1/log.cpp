...
class Logger {
   public:
    ...
    bool isLineNeeded() { return log_line; }

    bool isFileNeeded() { return log_file; }

    inline void Log(const string& message) { os << message; }
